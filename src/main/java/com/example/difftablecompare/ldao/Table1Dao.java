...
public class Table1Dao {
	private static final Logger LOGGER = LoggerFactory.getLogger(Table1Dao.class);
	...
	public List<Map<String,Object>> findById1(Object obj) {
	...
	public List<Map<String,Object>> findMinAndMaxId1() {
		List<Map<String,Object>> resultList=new ArrayList<>();
	...
	public List<Map<String,Object>> findBetweenId1s(Object obj1,Object obj2) {
		List<Map<String,Object>> resultList=new ArrayList<>();
